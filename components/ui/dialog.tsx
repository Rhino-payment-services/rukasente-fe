...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-1.5 border-b border-slate-200 px-5 py-4", className)}
      {...props}
    />
  );
}
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex items-center justify-end gap-2 border-t border-slate-200 px-5 py-3", className)}
      {...props}
    />
  );
}
